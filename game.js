...
var startGame = function() {
  ...
  if(ua.match(/android/)) {
    ...
    Game.setBoard(0,new Starfield(20,0.2,100,true));
...
var Starfield = function(speed,opacity,numStars,clear) {
  ...
  // Objek background bintang
  starCtx.fillStyle = "#7CFC00";
...
// pengaturan tentang pesawat player
// mengatur kecepatan bergerak dan peluru player
var PlayerShip = function() { 
  this.setup('ship', { vx: 100, reloadTime: 0.1, maxVel: 150 });
...
// jika player terkena damage, player kalah 
...
// pergerakan peluru player arah dan damagenya
